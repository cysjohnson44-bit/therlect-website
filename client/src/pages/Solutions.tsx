...
export default function Solutions() {
  ...
  const applicationDomains = [
    ...
    {
      title: isEn ? "Fully Automatic Water Cooling Plate Testing Machine" : "全自動水冷板測試機",
      description: isEn ? "Therlect's fully automatic water cooling plate testing machine integrates a precision chiller unit to provide comprehensive performance testing for water cooling plates. Engineers can conduct leak testing, flow resistance testing, and thermal performance verification with one-click automation, significantly improving testing efficiency and product quality consistency." : "汎海科技的全自動水冷板測試機，整合精密冷水機組，為水冷板提供全面的性能測試。工程師可一鍵自動化進行洩漏測試、流阻測試與散熱性能驗證，大幅提升測試效率與產品品質一致性。",
      detailedContent: isEn ? "The fully automatic water cooling plate testing machine is Therlect's self-developed precision testing equipment, specifically designed for water cooling plate quality verification:\n\n• Leak Testing: High-precision pneumatic/hydraulic leak detection ensuring zero-defect water cooling plates\n• Flow Resistance Testing: Automated measurement of flow resistance characteristics at various flow rates\n• Thermal Performance Verification: Integrated chiller unit simulating real operating conditions for heat dissipation testing\n• One-Click Automation: Full-process automated testing reducing human error and improving efficiency\n\nThe equipment integrates an industrial chiller unit providing stable low-temperature coolant, combined with high-precision sensors and automated control systems, enabling comprehensive performance evaluation of water cooling plates." : "全自動水冷板測試機是汎海科技自主研發的精密測試設備，專為水冷板品質驗證而設計：\n\n• 洩漏測試：高精度氣壓/液壓洩漏檢測，確保水冷板零缺陷\n• 流阻測試：自動化量測各流速下的流阻特性\n• 散熱性能驗證：整合冷水機模擬真實工況進行散熱測試\n• 一鍵自動化：全流程自動測試，降低人為誤差提升效率\n\n設備整合工業級冷水機組，提供穩定的低溫冷却液，配合高精度感測器與自動化控制系統，實現水冷板的全面性能評估。",
      items: isEn ? ["Leak Testing", "Flow Resistance Testing", "Thermal Performance Verification", "One-Click Automated Testing"] : ["洩漏測試", "流阻測試", "散熱性能驗證", "一鍵自動化測試"],
      image: "https://d2xsxph8kpxj0f.cloudfront.net/310519663272903053/6a2H4uYcRvYtNrWj4wnxzN/water_cooling_test_machine-DqwX7ZAf9CHqGzxPu6uQzp.webp"
    }
  ];
