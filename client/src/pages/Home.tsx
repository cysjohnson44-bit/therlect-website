        ...
        <div className="container">
          ...
          <div className="max-w-6xl mx-auto">
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
              ...
              {[
                { name: 'National Taiwan University', url: 'https://files.manuscdn.com/user_upload_by_module/session_file/310519663272903053/RNiESZscjhgDPyRM.png' },
                { name: 'Cruise', url: 'https://files.manuscdn.com/user_upload_by_module/session_file/310519663272903053/mBdKrsfWBFzNjdxt.png' },
                { name: 'AUO', url: 'https://files.manuscdn.com/user_upload_by_module/session_file/310519663272903053/fTjFJaaDTvPzWnqG.png' },
                { name: 'MYTEK', url: 'https://files.manuscdn.com/user_upload_by_module/session_file/310519663272903053/gYDdGzoyFvNlwNCv.png' },
                { name: 'Auden', url: 'https://files.manuscdn.com/user_upload_by_module/session_file/310519663272903053/giGBwbGUAUNVTrBA.png' },
                { name: 'Partner 6', url: 'https://files.manuscdn.com/user_upload_by_module/session_file/310519663272903053/XELNXZHJstGUbzIU.png' },
                { name: 'Partner 7', url: 'https://files.manuscdn.com/user_upload_by_module/session_file/310519663272903053/LMaowvMgAlfDncAF.png' },
                { name: 'Partner 8', url: 'https://files.manuscdn.com/user_upload_by_module/session_file/310519663272903053/eicRUOmbOjZBBFih.png' },
                { name: 'Partner 9', url: 'https://files.manuscdn.com/user_upload_by_module/session_file/310519663272903053/EXqNhzOjFcrpjNdL.png' },
                { name: 'Partner 10', url: 'https://files.manuscdn.com/user_upload_by_module/session_file/310519663272903053/gvRSavaBPazleJVF.png' },
                { name: 'Partner 11', url: 'https://files.manuscdn.com/user_upload_by_module/session_file/310519663272903053/estsNDgtGcCvkCOf.png' },
                { name: 'Partner 12', url: 'https://files.manuscdn.com/user_upload_by_module/session_file/310519663272903053/CKZFCOZBYIOKIvPO.png' },
                { name: 'Partner 13', url: 'https://files.manuscdn.com/user_upload_by_module/session_file/310519663272903053/PQfLqyfIGMkYFkfI.png' },
                { name: 'Partner 14', url: 'https://files.manuscdn.com/user_upload_by_module/session_file/310519663272903053/zjhdyJtFExjVVHGr.png' },
                { name: 'Partner 15', url: 'https://files.manuscdn.com/user_upload_by_module/session_file/310519663272903053/mgKFkVXPGsOqZddu.png' },
                { name: 'Partner 16', url: 'https://files.manuscdn.com/user_upload_by_module/session_file/310519663272903053/nMjWQGRVpxEfLvRN.png' },
                { name: 'Partner 17', url: 'https://files.manuscdn.com/user_upload_by_module/session_file/310519663272903053/ZewwKchYicfiDBkE.png' },
                { name: 'Partner 18', url: 'https://files.manuscdn.com/user_upload_by_module/session_file/310519663272903053/UERVnrMrUMUvzDVG.png' },
                { name: 'Partner 19', url: 'https://files.manuscdn.com/user_upload_by_module/session_file/310519663272903053/NgvNhaPYbRUDTUPU.png' },
                { name: 'Partner 20', url: 'https://files.manuscdn.com/user_upload_by_module/session_file/310519663272903053/EkuPHNLoXVmklvnW.png' },
                { name: 'Partner 21', url: 'https://files.manuscdn.com/user_upload_by_module/session_file/310519663272903053/GugFulutZWfiKRQu.png' },
                { name: 'Partner 22', url: 'https://files.manuscdn.com/user_upload_by_module/session_file/310519663272903053/bCioKmfxBqlNarlM.png' },
              ].map((logo, index) => (
                <div
                  key={index}
