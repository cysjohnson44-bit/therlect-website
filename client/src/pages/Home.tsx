        ...
        <div className="container">
          ...
          <div className="max-w-6xl mx-auto">
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
              ...
              {[
                { name: 'Partner 1', url: '/manus-storage/logo_01_974480e1.png' },
                { name: 'Partner 2', url: '/manus-storage/logo_02_75f90297.png' },
                { name: 'Partner 3', url: '/manus-storage/logo_03_0ecb66d9.png' },
                { name: 'Partner 4', url: '/manus-storage/logo_04_670f34c2.png' },
                { name: 'Partner 5', url: '/manus-storage/logo_05_c92a07e0.png' },
                { name: 'Partner 6', url: '/manus-storage/logo_06_68ce7328.png' },
                { name: 'Partner 7', url: '/manus-storage/logo_07_f834b187.png' },
                { name: 'Partner 8', url: '/manus-storage/logo_08_776bcabc.png' },
                { name: 'Partner 9', url: '/manus-storage/logo_09_35294a4c.png' },
                { name: 'Partner 10', url: '/manus-storage/logo_10_5be893c3.png' },
                { name: 'Partner 11', url: '/manus-storage/logo_11_4e805340.png' },
                { name: 'Partner 12', url: '/manus-storage/logo_12_3cc20bfb.png' },
                { name: 'Partner 13', url: '/manus-storage/logo_13_8a0c6b50.png' },
                { name: 'Partner 14', url: '/manus-storage/logo_14_cfe1de64.png' },
                { name: 'Partner 15', url: '/manus-storage/logo_15_bbdddc0d.png' },
                { name: 'Partner 16', url: '/manus-storage/logo_16_53317736.png' },
                { name: 'Partner 17', url: '/manus-storage/logo_17_46b46b87.png' },
                { name: 'Partner 18', url: '/manus-storage/logo_18_bf02c10f.png' },
                { name: 'Partner 19', url: '/manus-storage/logo_19_19e61ca1.png' },
                { name: 'Partner 20', url: '/manus-storage/logo_20_3379c5b4.png' },
                { name: 'Partner 21', url: '/manus-storage/logo_21_09503238.png' },
                { name: 'Partner 22', url: '/manus-storage/logo_22_4cfdd3f1.png' },
              ].map((logo, index) => (
                <div
                  key={index}
