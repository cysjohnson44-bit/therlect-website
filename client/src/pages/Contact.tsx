      ...
      <section className="py-20 relative">
        <div className="container">
          <div className="max-w-4xl mx-auto">
            <h2 className="font-display font-bold text-3xl md:text-4xl mb-4 text-center">如何查看客戶訊息</h2>
            <p className="text-center text-muted-foreground text-lg mb-12">
              您需要使用正常的郵件客戶端查看 jimmy.chen@therlect.com 的收件箱。以下是三種常見的方式：
            </p>

            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {/* Web Email */}
              <div className="bg-card border border-white/10 rounded-xl p-8 hover:border-primary/50 transition-colors">
                <div className="w-12 h-12 rounded-lg bg-primary/10 flex items-center justify-center mb-6">
                  <Mail className="w-6 h-6 text-primary" />
                </div>
                <h3 className="font-bold text-xl mb-4">網頁郵箱</h3>
                <div className="space-y-3 text-sm text-muted-foreground">
                  <p className="font-medium text-foreground">步驟：</p>
                  <ol className="space-y-2 list-decimal list-inside">
                    <li>登入 <span className="font-mono text-primary">jimmy.chen@therlect.com</span> 的郵件服務</li>
                    <li>例如 Gmail、Outlook 等</li>
                    <li>查看收件箱中的訊息</li>
                  </ol>
                </div>
              </div>
              ...
              <div className="bg-card border border-white/10 rounded-xl p-8 hover:border-primary/50 transition-colors">
                ...
                <h3 className="font-bold text-xl mb-4">郵件應用</h3>
                <div className="space-y-3 text-sm text-muted-foreground">
                  <p className="font-medium text-foreground">步驟：</p>
                  <ol className="space-y-2 list-decimal list-inside">
                    <li>在 Outlook、Apple Mail 等應用中添加帳戶</li>
                    <li>輸入 <span className="font-mono text-primary">jimmy.chen@therlect.com</span></li>
                    <li>查看收件箱</li>
                  </ol>
                </div>
              </div>
              ...
              <div className="bg-card border border-white/10 rounded-xl p-8 hover:border-primary/50 transition-colors">
                ...
                <h3 className="font-bold text-xl mb-4">手機郵件</h3>
                <div className="space-y-3 text-sm text-muted-foreground">
                  <p className="font-medium text-foreground">步驟：</p>
                  <ol className="space-y-2 list-decimal list-inside">
                    <li>在手機郵件應用中添加此帳戶</li>
            ...
            <div className="mt-12 p-6 bg-primary/5 border border-primary/20 rounded-xl">
              <p className="text-center text-sm text-muted-foreground">
                <span className="font-medium text-foreground">提示：</span> 客戶提交聯絡表單時，訊息會自動發送到 jimmy.chen@therlect.com 的郵箱。您也可以在管理面板中查看和回覆訊息。
              </p>
            </div>
          </div>
        </div>
